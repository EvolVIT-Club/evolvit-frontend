...
function MemberCard({ member, index, inView }: { member: Member; index: number; inView: boolean }) {
  ...
  const instagram = member.socials?.instagram || member.Instagram || member.instagram;
      ...
      <div className={styles.card}>
        ...
        <div className={styles.info}>
          ...
          <div className={styles.socialRow}>
            {twitter && (
              <a href={twitter} className={styles.socialIcon} title="Twitter" target="_blank" rel="noopener noreferrer">
            ...
            {instagram && (
              <a href={instagram} className={styles.socialIcon} title="Instagram" target="_blank" rel="noopener noreferrer">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
            ...
            {linkedin && (
              <a href={linkedin} className={styles.socialIcon} title="LinkedIn" target="_blank" rel="noopener noreferrer">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
            ...
            {github && (
              <a href={github} className={styles.socialIcon} title="GitHub" target="_blank" rel="noopener noreferrer">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
